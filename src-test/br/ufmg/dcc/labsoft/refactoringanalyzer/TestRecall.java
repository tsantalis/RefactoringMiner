...
//				"Inline Method private findTarget(t Object) : Object inlined to public setTarget(t Object) : void in class org.argouml.cognitive.checklist.ui.TabChecklist",
		...
		.containsOnly(
				...
				// method getCriticizedDesignMaterials not moved, but actually getCreateStereotype from WizAddConstructor to CrTooManyStates
				//"**Move Method getCriticizedDesignMaterials moved from class org.argouml.uml.cognitive.critics.WizAddConstructor to class org.argouml.uml.cognitive.critics.CrTooManyStates",
				...
				// method moved, but has only one line
				"**Move Method canEdit moved from class org.argouml.uml.diagram.use_case.ui.FigInclude to class org.argouml.uml.diagram.use_case.ui.SelectionActor")
...
//				"Push Down Attribute private cover : FigCube from class org.argouml.uml.diagram.deployment.ui.AbstractFigNode to class org.argouml.uml.diagram.deployment.ui.FigNodeInstance",
		...
		.containsOnly(
				...
				// the method was at SelectionClassifierBox, which is the superclass (it's wrong in the spreadsheet)
				"**Push Down Method org.argouml.uml.diagram.ui.FigEdgeModelElement mouseReleased org.argouml.uml.diagram.static_structure.ui.SelectionClass, org.argouml.uml.diagram.static_structure.ui.SelectionInterface, org.argouml.uml.diagram.ui.SelectionClassifierBox",
				...
				// there is a refactoring indeed
				"**Push Down Method org.argouml.uml.cognitive.critics.UMLWizard offerSuggestion org.argouml.uml.cognitive.critics.WizBreakCircularComp, org.argouml.uml.cognitive.critics.WizNavigable, org.argouml.uml.cognitive.critics.WizAddConstructor, org.argouml.uml.cognitive.critics.WizAddOperation",
...
//				"Pull Up Attribute protected instructions : String from class org.argouml.uml.diagram.static_structure.ui.SelectionInterface to class org.argouml.uml.diagram.ui.SelectionClassifierBox",
				...
				// code was missing
				//"**Pull Up Attribute org.argouml.model.mdr.ExtensionMechanismsFactoryMDRImpl modelImpl org.argouml.model.mdr.AbstractUmlModelFactoryMDR",
		...
		.containsOnly(
				// getMechList remains in CompositeCM, but it is also added as abstract in ControlMech and implemented in other subclasses
				"**Pull Up Method getMechList  org.argouml.cognitive.CompositeCM  org.argouml.cognitive.ControlMech",
				...
				// code was missing, now there is a refactoring indeed
				"**Pull Up Method createPartition org.argouml.model.mdr.ActivityGraphsFactoryMDRImpl  org.argouml.model.mdr.AbstractUmlModelFactoryMDR",
				// code was missing
				//"**Pull Up Method set org.argouml.core.propertypanels.model.GetterSetterManagerImpl.ChangeabilityGetterSetter  org.argouml.core.propertypanels.model.GetterSetterManager.OptionGetterSetter",
...
//				"**Extract Method extractedMethod in class net.sourceforge.atunes.kernel.modules.cdripper.FlacEncoder",
		...
		.containsOnly(
				// There is a inline indeed. Maybe it was not detected because codeis small and had to be adapted
				"**Inline Method addHeaderRenderers in class net.sourceforge.atunes.gui.ColumnDecorator",
...
//				"Inline Method private persistRadios() : void inlined to public removeRadios(radios List<IRadio>) : void in class net.sourceforge.atunes.kernel.modules.radio.RadioHandler")
		...
		.containsOnly(
				// Not really a move method. There is still a isSongFavorite method in FavoritesSongsManager, but it only delegates to FavoritesObjectDataStore#isSongFavorite
				"**Move Method isSongFavorite net.sourceforge.atunes.kernel.modules.favorites.FavoritesSongsManager  net.sourceforge.atunes.kernel.modules.favorites.FavoritesObjectDataStore",
		...
		.containsOnly(
				...
				// This method has only one line and a field access was replaced by a method invocation (getter)
				"**Pull Up Method initialize() : void from class net.sourceforge.atunes.gui.AlbumTableColumnModel to net.sourceforge.atunes.gui.AbstractCommonColumnModel",
