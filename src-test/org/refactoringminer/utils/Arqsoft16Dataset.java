...
public class Arqsoft16Dataset {
  ...
  public Arqsoft16Dataset() {
    ...
    springBoot_48e893a.add(item("Push Down Method", "org.springframework.boot.context.embedded.AbstractConfigurableEmbeddedServletContainer#setDisplayName(String)", "rg.springframework.boot.context.embedded.AbstractEmbeddedServletContainerFactory#setDisplayName(String)\norg.springframework.boot.context.web.ErrorPageFilter#setDisplayName(String)"));
    springBoot_48e893a.add(item("Push Down Method", "org.springframework.boot.context.embedded.AbstractConfigurableEmbeddedServletContainer#getDisplayName()", "rg.springframework.boot.context.embedded.AbstractEmbeddedServletContainerFactory#getDisplayName()\norg.springframework.boot.context.web.ErrorPageFilter#getDisplayName()"));
    ...
    springBoot_48e893a.add(item("Extract Method", "org.springframework.boot.cli.command.run.RunCommand#run(OptionSet)", "org.springframework.boot.cli.command.run.RunCommand#aux(OptionSet)"));
    springBoot_48e893a.add(item("Extract Method", "org.springframework.boot.cli.command.test.TestRunner#run()", "org.springframework.boot.cli.command.test.TestRunner#verify() "));
    springBoot_48e893a.add(item("Extract Method", "org.springframework.boot.actuate.metrics.buffer.Buffers<B extends Buffer<?>>#doWith(final String, Consumer<B>)", "org.springframework.boot.actuate.metrics.buffer.Buffers<B extends Buffer<?>>#test(String) "));
    ...
    springBoot_48e893a.add(item("Inline Method", "org.springframework.boot.context.properties.EnableConfigurationPropertiesImportSelector#collectClasses(List<Object>)", "org.springframework.boot.context.properties.EnableConfigurationPropertiesImportSelector#registerBeanDefinitions(AnnotationMetadata, BeanDefinitionRegistry)"));
    ...
    springBoot_48e893a.add(item("Pull Up Field", "org.springframework.boot.actuate.autoconfigure.OnEnabledEndpointElementCondition#annotationType", "org.springframework.boot.autoconfigure.condition.SpringBootCondition#annotationType0"));
