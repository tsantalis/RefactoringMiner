...
public class TestAllRefactorings extends LightJavaCodeInsightFixtureTestCase {
	...
	public void testBatch2() throws Exception {
		...
		processRepositoryCommits(Arrays.asList(gitURLs), 1769, 9, 86);
	}
	...
	public void testBatch5() throws Exception {
		...
		processRepositoryCommits(Arrays.asList(gitURLs), 482, 4, 10);
	}
/*
	@Test
	public void testAllRefactorings() throws Exception {
		...
		test.assertExpectations(getProject(), 11203, 27, 293, false);
	}
 */
}
