...
public class TestAllRefactorings extends LightJavaCodeInsightFixtureTestCase {
	...
	public void testBatch1() throws Exception {
		...
		processRepositoryCommits(Arrays.asList(gitURLs), 2427, 2, 40);
	}
	...
	public void testBatch2() throws Exception {
		...
		processRepositoryCommits(Arrays.asList(gitURLs), 1774, 9, 86);
	}
	...
	public void testBatch3() throws Exception {
		...
		processRepositoryCommits(Arrays.asList(gitURLs), 3027, 6, 53);
	}
...
/*
	...
	public void testAllRefactorings() throws Exception {
		...
		test.assertExpectations(getProject(), 11253, 26, 290, false);
	}
 */
}
