...
public class UMLModelASTReader {
	...
	private void processJavaFileContents(Map<String, String> javaFileContents, boolean astDiff) {
		...
		for(String filePath : javaFileContents.keySet()) {
			...
			parser.setSource(charArray);
			if((javaFileContent.contains(FREE_MARKER_GENERATED) || javaFileContent.contains(FREE_MARKER_GENERATED_2) || javaFileContent.contains(ANTLR_GENERATED) || javaFileContent.contains(XTEXT_GENERATED) || javaFileContent.contains(LWJGL_GENERATED)) &&
