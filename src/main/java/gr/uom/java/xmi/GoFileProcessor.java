...
public class GoFileProcessor {
	private UMLModel umlModel;

	public GoFileProcessor(UMLModel umlModel) {
		this.umlModel = umlModel;
	}

	public void processGoFile(String filePath, String fileContent, boolean astDiff) {
		try {
			...
			if (astDiff) {
				...
				TreeContext treeContext = new GoTreeSitterNgTreeGenerator().generateFrom().stream(is);
