...
public class JavaFileProcessor {
	...
	public JavaFileProcessor(UMLModel umlModel) {
		this.umlModel = umlModel;
	}

	public void processJavaFile(String filePath, String javaFileContent, boolean astDiff, ASTParser parser) {
