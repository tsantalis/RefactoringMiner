...
=================
   ...
   * [Current precision and recall](documentation/accuracy.md#current-precision-and-recall)
      ...
      * [JavaScript Benchmark](documentation/accuracy.md#javascript-benchmark)
