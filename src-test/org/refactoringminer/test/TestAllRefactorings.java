...
public class TestAllRefactorings extends LightJavaCodeInsightFixtureTestCase {
	...
	public void testBatch2() throws Exception {
		...
		//TP: 3411  FP:  16  FN: 158
		processRepositoryCommits(Arrays.asList(gitURLs), 3411, 16, 158);
	}
	...
	public void testBatch3() throws Exception {
		...
		//TP: 2989  FP:  7  FN: 61
		processRepositoryCommits(Arrays.asList(gitURLs), 2987, 7, 61);
	}
...
/*
	...
	public void testAllRefactorings() throws Exception {
		...
		test.assertExpectations(getProject(), 11097, 29, 325, false);
	}
 */
}
