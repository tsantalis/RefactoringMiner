	...
	public void kadarDatasetRecallTest() throws Exception {
		...
		test.project("https://github.com/MatinMan/RefactoringDatasets.git", "junit")
				.atCommit("00e584db35fdb44b58eccaff7dc5ec6b0da7547a").containsOnly(
						...
						"Inline Method	private ruleFields() : List<FrameworkField> inlined to private  validateFields(errors List<Throwable>) : void  in class junit.src.main.java.org.junit.runners.BlockJUnit4ClassRunner");
