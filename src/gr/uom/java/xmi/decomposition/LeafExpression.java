...
public class LeafExpression extends AbstractCodeFragment {
	...
	public LeafExpression(PsiFile cu, String filePath, PsiElement expression, CodeElementType codeElementType, VariableDeclarationContainer container) {
    	this.locationInfo = new LocationInfo(cu, filePath, expression, codeElementType);
    	this.string = Formatter.format(expression);
	}

	public LeafExpression(PsiFile cu, String filePath, PsiElement expression, String expressionAsString, CodeElementType codeElementType, VariableDeclarationContainer container) {
		this.locationInfo = new LocationInfo(cu, filePath, expression, codeElementType);
		this.string = expressionAsString;
	}
