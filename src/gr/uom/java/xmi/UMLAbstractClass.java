...
public abstract class UMLAbstractClass {
    ...
    private Map<String, TypFct> fieldMap;


    public UMLAbstractClass(TypFct.Context context) {
    ...
    public void addAttribute(UMLAttribute attribute) {
        ...
        this.fieldMap.put(attribute.getName(),getTypeFact(attribute.getTypeGraph(), context));
