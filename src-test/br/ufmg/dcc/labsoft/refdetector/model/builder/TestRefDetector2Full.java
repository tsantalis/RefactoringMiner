...
//	    TestBuilder test = new TestBuilder(new GitHistoryRefactoringDetector2(), "c:/Users/danilofs/tmp");
	    ...
	    test.project("https://github.com/datastax/java-driver.git", "master") 
	    .atCommit("3a0603f8f778be3219a5a0f3a7845cda65f1e172").contains(
	    ...
	    .atCommit("d5134b15fe6545ec8ab5c2256006cd6fe19eac92").contains(
	      "Extract Method package getPreparedQuery(type QueryType, columns Set<ColumnMapper<?>>, options Option[]) : PreparedStatement extracted from package getPreparedQuery(type QueryType, options Option[]) : PreparedStatement in class com.datastax.driver.mapping.Mapper"); // bug varargs
	    ...
	    test.project("https://github.com/spring-projects/spring-data-neo4j.git", "master") 
	    .atCommit("ef2a0d63393484975854fc08ad0fd3abc7dd76b0").contains(
	    ...
	    test.project("https://github.com/neo4j/neo4j.git", "master") 
	    .atCommit("4beba7bbdf927486a5cbf298a0fb2be50905a590").contains(
	    ...
	    test.project("https://github.com/jersey/jersey.git", "master") 
	    .atCommit("ee5aa50af6b4586fbe92cab718abfae8113a81aa").contains(
