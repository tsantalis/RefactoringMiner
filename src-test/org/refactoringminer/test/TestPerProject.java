...
public class TestPerProject extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testProjects() throws Exception {
        processRepositoryCommits("https://github.com/apache/drill.git", 321, 0, 10);
        ...
        processRepositoryCommits("https://github.com/BuildCraft/BuildCraft.git", 38, 1, 4);
        processRepositoryCommits("https://github.com/HubSpot/Singularity.git", 6, 0, 0);
        processRepositoryCommits("https://github.com/katzer/cordova-plugin-local-notifications.git", 72, 0, 2);
        processRepositoryCommits("https://github.com/FasterXML/jackson-databind.git", 27, 0, 0);
        processRepositoryCommits("https://github.com/aws/aws-sdk-java.git", 591, 0, 2);
        processRepositoryCommits("https://github.com/linkedin/rest.li.git", 193, 0, 5);
        processRepositoryCommits("https://github.com/open-keychain/open-keychain.git", 23, 0, 0);
        ...
        processRepositoryCommits("https://github.com/google/guava.git", 10, 0, 0);
        ...
        processRepositoryCommits("https://github.com/Netflix/eureka.git", 74, 0, 0);
        ...
        processRepositoryCommits("https://github.com/spring-projects/spring-integration.git", 30, 0, 0);
        processRepositoryCommits("https://github.com/orfjackal/retrolambda.git", 6, 0, 0);
        ...
        processRepositoryCommits("https://github.com/gwtproject/gwt.git", 23, 0, 0);
        processRepositoryCommits("https://github.com/google/truth.git", 26, 0, 0);
        ...
        processRepositoryCommits("https://github.com/thymeleaf/thymeleaf.git", 9, 0, 0);
        processRepositoryCommits("https://github.com/PhilJay/MPAndroidChart.git", 11, 0, 0);
        processRepositoryCommits("https://github.com/spring-projects/spring-boot.git", 106, 0, 4);
        ...
        processRepositoryCommits("https://github.com/jfinal/jfinal.git", 245, 0, 13);
        processRepositoryCommits("https://github.com/oblac/jodd.git", 3, 0, 0);
        processRepositoryCommits("https://github.com/realm/realm-java.git", 15, 0, 0);
        ...
        processRepositoryCommits("https://github.com/hazelcast/hazelcast.git", 472, 3, 11);
        ...
        processRepositoryCommits("https://github.com/facebook/buck.git", 193, 0, 5);
        processRepositoryCommits("https://github.com/jayway/rest-assured.git", 2, 0, 0);
        processRepositoryCommits("https://github.com/graphhopper/graphhopper.git", 396, 2, 7);
        ...
        processRepositoryCommits("https://github.com/JetBrains/MPS.git", 19, 0, 0);
        ...
        processRepositoryCommits("https://github.com/infinispan/infinispan.git", 506, 3, 23);
        ...
        processRepositoryCommits("https://github.com/elastic/elasticsearch.git", 59, 0, 1);
        ...
        processRepositoryCommits("https://github.com/NLPchina/ansj_seg.git", 141, 0, 4);
        processRepositoryCommits("https://github.com/apache/camel.git", 12, 0, 0);
        processRepositoryCommits("https://github.com/droolsjbpm/drools.git", 128, 0, 2);
        ...
        processRepositoryCommits("https://github.com/crate/crate.git", 170, 0, 1);
        processRepositoryCommits("https://github.com/libgdx/libgdx.git", 2, 0, 0);
        processRepositoryCommits("https://github.com/hibernate/hibernate-orm.git", 101, 0, 0);
        ...
        processRepositoryCommits("https://github.com/apache/cassandra.git", 295, 4, 3);
        ...
        processRepositoryCommits("https://github.com/apache/hive.git", 77, 0, 3);
        processRepositoryCommits("https://github.com/google/closure-compiler.git", 73, 0, 0);
        ...
        processRepositoryCommits("https://github.com/checkstyle/checkstyle.git", 95, 0, 0);
        ...
        processRepositoryCommits("https://github.com/spring-projects/spring-data-mongodb.git", 2, 0, 0);
        ...
        processRepositoryCommits("https://github.com/MovingBlocks/Terasology.git", 51, 0, 4);
        processRepositoryCommits("https://github.com/GoClipse/goclipse.git", 10, 0, 0);
        processRepositoryCommits("https://github.com/google/j2objc.git", 9, 0, 0);
        processRepositoryCommits("https://github.com/SonarSource/sonarqube.git", 99, 0, 6);
        ...
        processRepositoryCommits("https://github.com/rstudio/rstudio.git", 25, 0, 7);
        ...
        processRepositoryCommits("https://github.com/Graylog2/graylog2-server.git", 67, 0, 2);
        processRepositoryCommits("https://github.com/SecUpwN/Android-IMSI-Catcher-Detector.git", 7, 0, 0);
        processRepositoryCommits("https://github.com/jline/jline2.git", 25, 0, 0);
        processRepositoryCommits("https://github.com/killbill/killbill.git", 29, 0, 0);
        processRepositoryCommits("https://github.com/VoltDB/voltdb.git", 111, 0, 1);
        ...
        processRepositoryCommits("https://github.com/osmandapp/Osmand.git", 11, 0, 0);
        processRepositoryCommits("https://github.com/openhab/openhab.git", 12, 0, 0);
        ...
        processRepositoryCommits("https://github.com/wordpress-mobile/WordPress-Android.git", 36, 0, 1);
        processRepositoryCommits("https://github.com/junit-team/junit5.git", 22, 0, 0);
        processRepositoryCommits("https://github.com/eclipse/jgit.git", 16, 0, 0);
        processRepositoryCommits("https://github.com/apache/commons-lang.git", 3, 0, 0);
    }
}
