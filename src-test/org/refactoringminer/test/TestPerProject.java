...
public class TestPerProject extends LightJavaCodeInsightFixtureTestCase {
    ...
    public void testProjects() throws Exception {
        ...
        processRepositoryCommits("https://github.com/wildfly/wildfly.git", 171, 1, 3);
        ...
        processRepositoryCommits("https://github.com/ignatov/intellij-erlang.git", 51, 0, 1);
        ...
        processRepositoryCommits("https://github.com/aws/aws-sdk-java.git", 591, 6, 8);
        processRepositoryCommits("https://github.com/linkedin/rest.li.git", 162, 0, 7);
        ...
        processRepositoryCommits("https://github.com/dropwizard/metrics.git", 16, 0, 0);
        processRepositoryCommits("https://github.com/google/guava.git", 9, 0, 0);
        processRepositoryCommits("https://github.com/apache/giraph.git", 41, 3, 0);
        ...
        processRepositoryCommits("https://github.com/Netflix/eureka.git", 72, 0, 0);
        ...
        processRepositoryCommits("https://github.com/spring-projects/spring-integration.git", 27, 0, 0);
        processRepositoryCommits("https://github.com/orfjackal/retrolambda.git", 3, 0, 0);
        processRepositoryCommits("https://github.com/tomahawk-player/tomahawk-android.git", 42, 0, 3);
        processRepositoryCommits("https://github.com/raphw/byte-buddy.git", 64, 0, 3);
        processRepositoryCommits("https://github.com/liferay/liferay-plugins.git", 12, 0, 0);
        processRepositoryCommits("https://github.com/jenkinsci/workflow-plugin.git", 6, 0, 0);
        ...
        processRepositoryCommits("https://github.com/jfinal/jfinal.git", 227, 0, 22);
        ...
        processRepositoryCommits("https://github.com/bennidi/mbassador.git", 15, 0, 0);
        processRepositoryCommits("https://github.com/Athou/commafeed.git", 1, 0, 0);
        processRepositoryCommits("https://github.com/hazelcast/hazelcast.git", 446, 3, 11);
        ...
        processRepositoryCommits("https://github.com/WhisperSystems/Signal-Android.git", 65, 0, 3);
        processRepositoryCommits("https://github.com/Activiti/Activiti.git", 15, 0, 0);
        ...
        processRepositoryCommits("https://github.com/graphhopper/graphhopper.git", 390, 2, 10);
        ...
        processRepositoryCommits("https://github.com/droolsjbpm/jbpm.git", 147, 1, 6);
        ...
        processRepositoryCommits("https://github.com/codefollower/Lealone.git", 10, 0, 0);
        ...
        processRepositoryCommits("https://github.com/infinispan/infinispan.git", 468, 3, 23);
        ...
        processRepositoryCommits("https://github.com/droolsjbpm/drools.git", 119, 1, 7);
        processRepositoryCommits("https://github.com/robovm/robovm.git", 482, 0, 2);
        processRepositoryCommits("https://github.com/bitcoinj/bitcoinj.git", 134, 0, 5);
        processRepositoryCommits("https://github.com/facebook/presto.git", 296, 1, 0);
        processRepositoryCommits("https://github.com/deeplearning4j/deeplearning4j.git", 13, 0, 1);
        processRepositoryCommits("https://github.com/crate/crate.git", 162, 0, 1);
        processRepositoryCommits("https://github.com/libgdx/libgdx.git", 2, 0, 0);
        processRepositoryCommits("https://github.com/hibernate/hibernate-orm.git", 95, 0, 0);
        processRepositoryCommits("https://github.com/Netflix/zuul.git", 8, 1, 0);
        processRepositoryCommits("https://github.com/ratpack/ratpack.git", 3, 0, 0);
        ...
        processRepositoryCommits("https://github.com/apache/cassandra.git", 279, 4, 5);
        ...
        processRepositoryCommits("https://github.com/checkstyle/checkstyle.git", 87, 0, 0);
        ...
        processRepositoryCommits("https://github.com/MovingBlocks/Terasology.git", 50, 0, 4);
        ...
        processRepositoryCommits("https://github.com/SonarSource/sonarqube.git", 94, 0, 6);
        ...
        processRepositoryCommits("https://github.com/languagetool-org/languagetool.git", 59, 0, 0);
        ...
        processRepositoryCommits("https://github.com/JetBrains/intellij-community.git", 197, 0, 6);
        ...
        processRepositoryCommits("https://github.com/openhab/openhab.git", 10, 0, 0);
        ...
        processRepositoryCommits("https://github.com/spring-projects/spring-security.git", 23, 0, 2);
        processRepositoryCommits("https://github.com/novoda/android-demos.git", 4, 0, 0);
        processRepositoryCommits("https://github.com/wordpress-mobile/WordPress-Android.git", 30, 0, 1);
    }
}
