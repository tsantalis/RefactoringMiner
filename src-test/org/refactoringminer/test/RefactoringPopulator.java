...
public class RefactoringPopulator {
	...
	public enum Refactorings {
		...
		ReplaceTryAndFailWithRule(new BigInteger("19807040628566084398385987584")),
		ReplaceExpectAnnotationWithAssertThrows(new BigInteger("39614081257132168796771975168")),
