...
//				"Extract Method private getAlbumFavoriteSearchOperator() : ISearchUnaryOperator extracted from public getOperators() : List in class net.sourceforge.atunes.kernel.modules.search.AlbumSearchField",
	...
	private static void FSE_ExtractMethodRefactorings(TestBuilder test, int flag) {
		...
		.atCommit("e235f884f2e0bc258da77b9c80492ad33386fa86")
		.containsOnly(
		...
		.atCommit("2801269c7e47bd6e243612654a74cee809d20959")
		.containsOnly(
		...
		.atCommit("7655200f58293e5a30bf8b3cbb29ebadae374564")
		.containsOnly(
		...
		.atCommit("722ef9156896248ef3fbe83adde0f6ff8f46856a")
		.containsOnly(
		...
		.atCommit("6cf596df183b3c3a38ed5dd9bb3b0100c6548ebb")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("7a4dab88185553bd09e827839fdf52e870ef7088")
		.containsOnly(
		...
		.atCommit("8127b21a220ca677c4e59961d019e7753da7ea6e")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("7ed3f273ab0caf0337c22f0b721d51829bb0c877")
		.containsOnly(
		...
		.atCommit("18a7bd1fd1a83b3b8d1b245e32f78c0b4443b7a7")
		.containsOnly(
		...
		.atCommit("1edac0e92080e7c5e971b2d56c8753bf44ea8a6c")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("cc0eaf7faa408a04b68e2b5820f3ebcc75420b5b")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("138911ce88b05039242b8d1b2bb5b7a59008f5ee")
		.containsOnly(
		...
		.atCommit("2b89553db5081fe4e55b7b34d636d0ea2acf71c5")
		.containsOnly(
		...
		.atCommit("ff9041dc486adf0a8dec41f80bbfbdd49f97016a")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("484038e916dc40bf87eca10c77889d79eca96c4d")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("219d6ddfd1db62c11efb57e0216436874e087834")
		.containsOnly(
		...
		.atCommit("59fd9e696cec5f2ed44c27422bbc426b11647321")
		.containsOnly(
		...
		.atCommit("96a2c3410f3c71d3ab20857036422f1d64c3a6d3")
		.containsOnly(
		...
		.atCommit("5a9b7249e3d092a78ac8e7d48aeeb62bf1c44e20")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("a97341973c3b683d62d1422e5404ed5c7ccf45f8")
		.containsOnly(
		...
		test.project("https://github.com/datastax/java-driver.git","master")
		.atCommit("3a0603f8f778be3219a5a0f3a7845cda65f1e172")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("d71154ed21e2d5c65bb0ddb000bcb04ca5735048")
		.containsOnly(
		...
		.atCommit("b40adc25008b6f608ee3eb3422c8884fff987337")
		.containsOnly(
		...
		.atCommit("1bf2875e9d73e2d1cd3b58200d5300485f890ff5")
		.containsOnly(
		...
		test.project("https://github.com/datastax/java-driver.git","master")
		.atCommit("d5134b15fe6545ec8ab5c2256006cd6fe19eac92")
		.containsOnly(
		...
		.atCommit("669e0722324965e3c99f29685517ac24d4ff2848")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("e9efc045fbc6fa893c66a03b72b7eedb388cf96c")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("658a918eebcbdeb4f920c2947ca8d0e79ad86d89")
		.containsOnly(
		...
		.atCommit("20d39f7af2165c67d5221f556f58820c992d2cc6")
		.containsOnly(
		...
		test.project("https://github.com/fabric8io/fabric8.git","master")
		.atCommit("9e61a71540da58c3208fd2c7737f793c3f81e5ae")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-boot.git","master")
		.atCommit("1cfc6f64f64353bc5530a8ce8cdacfc3eba3e7b2")
		.containsOnly(
		...
		test.project("https://github.com/Netflix/eureka.git","master")
		.atCommit("1cacbe2ad700275bc575234ff2b32ee0d6493817")
		.containsOnly(
		...
		.atCommit("bd0d3bf75d31a8b5db34b8b66dfb28e5e1f492de")
		.containsOnly(
		...
		test.project("https://github.com/orientechnologies/orientdb.git","master")
		.atCommit("1089957b645bde069d3864563bbf1f7c7da8045c")
		.containsOnly(
		...
		.atCommit("f1533756133dec84ce8218202585ac85904da7c9")
		.containsOnly(
		...
		.atCommit("6599c748ef35d38085703cf3bd41b9b5b6af5f32")
		.containsOnly(
		...
		.atCommit("e3b0d87b3ca0fd27cec39937cb3dc3a05b0cfc4e")
		.containsOnly(
		...
		.atCommit("c7b6a7aa878aabd6400d2df0490e1eb2b810c8f9")
		.containsOnly(
		...
		.atCommit("6abc40ed4850d74ee6c155f5a28f8b34881a0284")
		.containsOnly(
		...
		.atCommit("ec52e77ecde749e7c5a483b26cbd8041f2a5a33c")
		.containsOnly(
		...
		.containsOnly(
		"Extract Method public has(key NSString) : boolean extracted from public getLocalName() : String and public getServiceUUIDs() : NSArray<CBUUID> in class org.robovm.apple.corebluetooth.CBAdvertisementData",
		...
		"Extract Method public has(key CFString) : boolean extracted from public getColorModel() : CGImagePropertyColorModel and 8 others in class org.robovm.apple.imageio.CGImageProperties");
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("c9b2006381301c99b66c50c4b31f329caac06137")
		.containsOnly(
		...
		.atCommit("f26d234e8d3458f34454583c22e3bd5f4b2a5da8")
		.containsOnly(
		...
		.atCommit("ea96643364e91125f560e9508a5cbcdb776bde64")
		.containsOnly(
		...
		.atCommit("0d4b27952751de0caab01774048c3e0ec74824ce")
		.containsOnly(
		...
		.atCommit("1f3be625e62f44d929c01f6574678eea05754474")
		.containsOnly(
		...
		.atCommit("0b024834549c53512ef18bce89f60ef9225d4819")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-boot.git","master")
		.atCommit("b47634176fa48ad925f79886c6aaca225cb9af64")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-boot.git","master")
		.atCommit("cb98ee25ff52bf97faebe3f45cdef0ced9b4416e")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("15fd4f9caea01e53725086e290d3b35ec4bd4cd9")
		.containsOnly(
		...
		test.project("https://github.com/Netflix/eureka.git","master")
		.atCommit("5103ace802b2819438318dd53b5b07512aae0d25")
		.containsOnly(
		...
		.atCommit("f01d8610b9ceebc1de59d42f569b8af3efbe0a0f")
		.containsOnly(
		...
		test.project("https://github.com/rstudio/rstudio.git","master")
		.atCommit("9a581e07cb6381d70f3fd9bb2055e810e2a682a9")
		.containsOnly(
		...
		.atCommit("247232bdde24b81814a82100743f77d881aaf06b")
		.containsOnly(
		...
		.atCommit("c11fef6e7c80681ce69e5fdc7f4796b0b7a18e2b")
		.containsOnly(
		...
		.atCommit("7a1659c12d76b510809dea1dea1f5100bcf4cd60")
		.containsOnly(
		...
		.atCommit("480537e0f8aaf50a7648bf445b33230aa32a9b44")
		.containsOnly(
		...
		.atCommit("881baed894540031bd55e402933bcad28b74ca88")
		.containsOnly(
		...
		.atCommit("b83e6a535cbca21d5ea764b0c49bfca8a9ff9db4")
		.containsOnly(
		...
		.atCommit("d949fe9079a82ee31aa91244aa67baaf56b7e28f")
		.containsOnly(
		...
		test.project("https://github.com/wordpress-mobile/WordPress-Android.git","master")
		.atCommit("ab298886b59f4ad0235cd6d5764854189eb59eb6")
		.containsOnly(
		...
		.atCommit("c265bde2ace252bc1e1c65c6af93520e5994edd2")
		.containsOnly(
		...
		.atCommit("ed966510ccf8441115614e2258aea61df0ea55f5")
		.containsOnly(
		...
		.atCommit("23c49d834d3859fc76a604da32d1789d2e863303")
		.containsOnly(
		...
		.atCommit("a9ca2efae56815dc464189b055ffe9da23766f7f")
		.containsOnly(
		...
		.atCommit("ece12f9d370108549fffac105e4bcb7faeaaf124")
		.containsOnly(
		...
		test.project("https://github.com/infinispan/infinispan.git","master")
		.atCommit("03573a655bcbb77f7a76d8e22d851cc22796b4f8")
		.containsOnly(
		...
		.atCommit("797fb7fc1415ac0ebe9a8262677dfa4462ed6cb4")
		.containsOnly(
		...
		test.project("https://github.com/wordpress-mobile/WordPress-Android.git","master")
		.atCommit("4bfe164cc8b4556b98df18098b162e0a84038b32")
		.containsOnly(
		...
		.atCommit("5e08a9e8e93a2f117b5fbec9c6d54500d8e99a4d")
		.containsOnly(
		...
		test.project("https://github.com/rstudio/rstudio.git","master")
		.atCommit("4983f83d1bedb7b737fc56d409c1c06b04e34e4e")
		.containsOnly(
		...
		.atCommit("7c7ecf4cffda166938efd0ae34830e2979c25c73")
		.containsOnly(
		...
		.atCommit("2d036ecf1d7170b4ec7346579a1ef8904109530a")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("7e104c3ed4b80ec8e9b72356396f879d1067cc40")
		.containsOnly(
		...
		.atCommit("5fb36a321af7df470d4c845cb18da8f85be31c38")
		.containsOnly(
		...
		test.project("https://github.com/open-keychain/open-keychain.git","master")
		.atCommit("de50b3becb31c367f867382ff9cd898ba1628350")
		.containsOnly(
		...
		.atCommit("c45b9e6615181b7d8f4d7b5b1cc141169081c02c")
		.containsOnly(
		...
		.atCommit("ffae1691c0cd526ed1095fbabbc0855d016790d7")
		.containsOnly(
		...
		.atCommit("7a2e0ae5f6172cbe34f9bc4a5cde666314ff75dd")
		.containsOnly(
		...
		.atCommit("4ffcb5a65e6d24c58ef75a5cd7692e875619548d")
		.containsOnly(
		...
		test.project("https://github.com/phishman3579/java-algorithms-implementation.git","master")
		.atCommit("f2385a56e6aa040ea4ff18a23ce5b63a4eeacf29")
		.containsOnly(
		...
		test.project("https://github.com/droolsjbpm/drools.git","master")
		.atCommit("c8e09e2056c54ead97bce4386a25b222154223b1")
		.containsOnly(
		...
		test.project("https://github.com/k9mail/k-9.git","master")
		.atCommit("9d44f0e06232661259681d64002dd53c7c43099d")
		.containsOnly(
		...
		.atCommit("01cddc5afb590b4d36cb784637a8ea8aa31d3561")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("74d2cc420e5590ba3bc0ffcc15b30b76a9cbef0b")
		.containsOnly(
		...
		.atCommit("8ea46f48063c38473c12ca7c114106ca910b6e74")
		.containsOnly(
		...
		.atCommit("70a25d4afdc435e9cad4460b2a20b7aabdd21e35")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-framework.git","master")
		.atCommit("31a5434ea433bdec2283797bf9415c02bb2f41c1")
		.containsOnly(
		...
		test.project("https://github.com/wordpress-mobile/WordPress-Android.git","master")
		.atCommit("3b95d10985776fb7b710089ff71074fd2bf860ee")
		.containsOnly(
		...
		.atCommit("186357ac6c2da1a5a12c0287a08408ac5ec6683b")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("ebb1c2c364e888d4a0f47abe691cb2bad4eb4e75")
		.containsOnly(
		...
		.atCommit("a9b1e5d67421ed98b49ae25c3bbd6e27a0ab1590")
		.containsOnly(
		...
		test.project("https://github.com/apache/drill.git","master")
		.atCommit("711992f22ae6d6dfc43bdb4c01bf8f921d175b38")
		.containsOnly(
		...
		.atCommit("b7f4914d81a7a618acf2eba52af1093fc23cfba9")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-boot.git","master")
		.atCommit("becced5f0b7bac8200df7a5706b568687b517b90")
		.containsOnly(
		...
		.atCommit("0b93231025f51c7ec62fd8588985c5dc807854e4")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("9a3fa887cfa03c082f249d1d4003d87c14ba5d24")
		.containsOnly(
		...
		test.project("https://github.com/mongodb/morphia.git","master")
		.atCommit("5db323b99f7064af8780f2c35f245461cf55cc8e")
		.containsOnly(
		"Extract Method private performBasicMappingTest() : void extracted from public testBasicMapping() : void in class org.mongodb.morphia.TestMapping");

		test.project("https://github.com/go-lang-plugin-org/go-lang-idea-plugin.git","master")
		.atCommit("b8929ccb4057c74ac64679216487a4abcd3ae1c3")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("d3533c1a0716ca114d294b3ea183504c9725698f")
		.containsOnly(
		...
		test.project("https://github.com/go-lang-plugin-org/go-lang-idea-plugin.git","master")
		.atCommit("3d5e343df6a39ce3b41624b90974d83e9899541e")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("5f78f9ef1e6c798849d34cc66721e6c1d9709b6f")
		.containsOnly(
		...
		.atCommit("37d842bfed9779e662321a5ee43c36b058386843")
		.containsOnly(
		...
		.atCommit("b25d3f32ed2e2da86f5c746098686445c2e2a314")
		.containsOnly(
		...
		.atCommit("fab1516773d50bf86d9cc37e2f6db13496f0ecae")
		.containsOnly(
		...
		.atCommit("2fd96c777164dd812e8b5a4294b162889601df1d")
		.containsOnly(
		...
		test.project("https://github.com/bitcoinj/bitcoinj.git","master")
		.atCommit("1d96e1ad1dca6e2151603e10515bb04f0c2730fc")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("f797bfa4da53315b49f8d97b784047f33ba1bf5f")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("d49765899cb9df6781fff9773ffc244b5167351c")
		.containsOnly(
		...
		.atCommit("add1d4f07c925b8a9044cb3aa5bb4abdeaf49fc7")
		.containsOnly(
		...
		test.project("https://github.com/apache/drill.git","master")
		.atCommit("3f0d9221d3f96c20db10e868cc33c2e972318ba6")
		.containsOnly(
		...
		test.project("https://github.com/SonarSource/sonarqube.git","master")
		.atCommit("0d9fcaa4415ee996e423a97cfe0d965586ca59a5")
		.containsOnly(
		...
		.atCommit("4b5b74b6467a28fb9b7712f8091e4aa61c2d64b6")
		.containsOnly(
		...
		.atCommit("d4992887291cc0a7eeda87ad547fa9e1e7fda41c")
		.containsOnly(
		...
		.atCommit("c64217e2b485f3c6b997a55b1ef910c8b72779d3")
		.containsOnly(
		...
		test.project("https://github.com/datastax/java-driver.git","master")
		.atCommit("9de5f0d408f861455716b8410fd53f62b360787d")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("7eb3567e7880511b76b8b65e8eb7d373927f2fb6")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("e58c9c3eef4c6e44b21a97cfbd2862bb2eb4627a")
		.containsOnly(
		...
		.atCommit("1bc7905b07821f840068089343e6b77a8686d1ab")
		.containsOnly(
		...
		.atCommit("0e7345a9c10863dca9217ad902b825db50fed01f")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("102b23b16bf26cbf439009b4b95542490a082710")
		.containsOnly(
		...
		test.project("https://github.com/gradle/gradle.git","master")
		.atCommit("79c66ceab11dae0b9fd1dade7bb4120028738705")
		.containsOnly(
		...
		.atCommit("c13f3469e1d64ec97b11f0509e45f9c3fa8ff88a")
		.containsOnly(
		...
		.atCommit("a739d16d301f0e89ab0b9dfa56b4585bbad6b793")
		.containsOnly(
		...
		test.project("https://github.com/droolsjbpm/jbpm.git","master")
		.atCommit("83cfa21578e63956bca0715eefee2860c3b6d39a")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("35668435090eb47cf8c5e704243510b6cee35a7b")
		.containsOnly(
		...
		.atCommit("cfe88fe3fbcc6b02ca55cee7b1f4ab13e249edea")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("d1a6ae2a16ba1d53b1de02eea8745d67c6a1a005")
		.containsOnly(
		...
		.atCommit("85a690e3cdbbb8447342eefdf690e22ad1b33e02")
		.containsOnly(
		...
		.atCommit("b8fffb706258db4c4d2f608d8e8dad9312e2230d")
		.containsOnly(
		...
		test.project("https://github.com/deeplearning4j/deeplearning4j.git","master")
		.atCommit("3325f5ccd23f8016fa28a24f878b54f1918546ed")
		.containsOnly(
		...
		test.project("https://github.com/crate/crate.git","master")
		.atCommit("d5f10a4958f5e870680be906689d92d1efb42480")
		.containsOnly(
		...
		.atCommit("200f1577d238a6d3fbcf99cb2a2585b2071214a6")
		.containsOnly(
		...
		test.project("https://github.com/wildfly/wildfly.git","master")
		.atCommit("c0f8a7f2b4341601df63c5470f41f157dbd83781")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("4587c32ab8a1c8e2169e4f93491a8c927216a6ab")
		.containsOnly(
		...
		test.project("https://github.com/apache/drill.git","master")
		.atCommit("b2bbd9941be6b132a83d27c0ae02c935e1dec5dd")
		.containsOnly(
		...
		test.project("https://github.com/spring-projects/spring-framework.git","master")
		.atCommit("ef0eb01f93d6c485cf37692fd193833a6821272a")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("b8d2140fe4faccadcf1a6343ec8cd0cc58c315f9")
		.containsOnly(
		...
		test.project("https://github.com/nutzam/nutz.git","master")
		.atCommit("de7efe40dad0f4bb900c4fffa80ed377745532b3")
		.containsOnly(
		...
		test.project("https://github.com/amplab/tachyon.git","master")
		.atCommit("b0938501f1014cf663e33b44ed5bb9b24d19a358")
		.containsOnly(
		...
		.atCommit("46b0d84de9c309bca48a99e572e6611693ed5236")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/MPS.git","master")
		.atCommit("7b5622d41537315710b6fd57b2739a3a64698375")
		.containsOnly(
		...
		test.project("https://github.com/facebook/facebook-android-sdk.git","master")
		.atCommit("19d1936c3b07d97d88646aeae30de747715e3248")
		.containsOnly(
		...
		.atCommit("f0b2cc559026871c1b4d8e008666afb590553004")
		.containsOnly(
		...
		test.project("https://github.com/bitcoinj/bitcoinj.git","master")
		.atCommit("95bfa40630e34f6f369e0055d9f37f49bca60247")
		.containsOnly(
		...
		test.project("https://github.com/WhisperSystems/TextSecure.git","master")
		.atCommit("c4a37e38aba926c2bef27e4fc00e3a4848ce46bd")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("f664789737d516ac664462732664121acc111a1e")
		.containsOnly(
		...
		test.project("https://github.com/amplab/tachyon.git","master")
		.atCommit("9aeefcd8120bb3b89cdb437d8c32d2ed84b8a825")
		.containsOnly(
		...
		test.project("https://github.com/crate/crate.git","master")
		.atCommit("563d281b61e9f8748858e911eaa810e981f1e953")
		.containsOnly(
		...
		.atCommit("bdc9f9a44f337ab595a3570833dc6a0558df904c")
		.containsOnly(
		...
		test.project("https://github.com/openhab/openhab.git","master")
		.atCommit("cf1efb6d27a4037cdbe5a780afa6053859a60d4a")
		.containsOnly(
		...
		.atCommit("da39bfeb9c370abe2d86e6e327fade252434090d")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("910397f2390d6821a006991ed6035c76cbc74897")
		.containsOnly(
		...
		.atCommit("944aea445051891280a8ab7fbbd514c19646f1ab")
		.containsOnly(
		...
		.atCommit("8fc60d81fe0e46e7e5c96e71d4a93fcadc6bde4f")
		.containsOnly(
		...
		test.project("https://github.com/google/auto.git","master")
		.atCommit("8967e7c33c59e1336e1e3b4671293ced5697fca6")
		.containsOnly(
		...
		test.project("https://github.com/thymeleaf/thymeleaf.git","master")
		.atCommit("378ba37750a9cb1b19a6db434dfa59308f721ea6")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("e1625136ba12907696ef4c6e922ce073293f3a2c")
		.containsOnly(
		...
		test.project("https://github.com/apache/camel.git","master")
		.atCommit("cb0935e3af05b333b5c85a4fb3b1846836218f11")
		.containsOnly(
		...
		test.project("https://github.com/spotify/helios.git","master")
		.atCommit("dd8753cfb0f67db4dde6c5254e2df3104b635dae")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("76331570e68446c17e4ff5287f5b7b2b6b472895")
		.containsOnly(
		...
		.atCommit("a7401e5091c06c68fae499ea1972b40143c66fa9")
		.containsOnly(
		...
		test.project("https://github.com/deeplearning4j/deeplearning4j.git","master")
		.atCommit("3d080545362794ac5ab63a6cf1bdfb523a0d92a5")
		.containsOnly(
		...
		.atCommit("679d38d4316c16ccba4982d7f3ba13c147a451cb")
		.containsOnly(
		...
		.atCommit("c1a9dd63aca8bf488f9a671aa6281538540397f8")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("5fa74fbb4a307571e3807c1201b8b05d3d60a99b")
		.containsOnly(
		...
		.atCommit("80d3ffb5aafa90992385c17e8338c2cc5def3cec")
		.containsOnly(
		...
		.atCommit("9687048f76519fc89b4151cbe2841bbba61a401d")
		.containsOnly(
		...
		.atCommit("b2b4085348de32f10903970dded99fdf0376a43c")
		.containsOnly(
		...
		test.project("https://github.com/structr/structr.git","master")
		.atCommit("15afd616cba5fb3d432d11a6de0d4f7805b202db")
		.containsOnly(
		...
		.atCommit("64938ebcfc2fc8cd9ccd6cf31dbcd8cdd0660aca")
		.containsOnly(
		...
		.atCommit("e29924b33ec0c0298ba4fc3f7a8c218c8e6cfa0c")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("af618666043f21b3db7e6a1be2aa225ae0f432b4")
		.containsOnly(
		...
		test.project("https://github.com/droolsjbpm/drools.git","master")
		.atCommit("7ffc62aa554f5884064b81ee80078e35e3833006")
		.containsOnly(
		...
		.atCommit("a70ca1d9ad2ea07b19c5e1f9540c809d7a12d3fb")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("106d1d51754f454fa673976665e41f463316e084")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("8184a32a019b2ed956e8f24c18cb49a266af47bf")
		.containsOnly(
		...
		test.project("https://github.com/linkedin/rest.li.git","master")
		.atCommit("ec5ea36faa3dd74585bb339beabdba6149ed63be")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("999e0e3616525d77cf46c5865f9981b5a6b5609a")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("9f7de200c9aef900596b09327a52d33241a68d9c")
		.containsOnly(
		"Extract Method private dummy(builder PsiBuilder) : void extracted from public parseTypeParameter(builder PsiBuilder) : Marker in class com.intellij.lang.java.parser.ReferenceParser");

		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("a9379ee529ed87e28c0736c3c6657dcd6a0680e4")
		.containsOnly(
		...
		.atCommit("3b1f4e56fea289860b31ef83ccfe96a3a003cc8b")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("52cfd39ecba349c4d8e2c46eac76ed4d75b7ebae")
		.containsOnly(
		...
		.atCommit("0f9d0b0bf1cd5fb58f47f22bd6d52a9fac31c530")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("7c59f2a4f9b03a9e48ca15554291a03477aa19c1")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("10f769a60c7c7b73982e978959d381df487bbe2d")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("619a6012da868d0d42d9628460f2264effe9bdba")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("e1f0dbc2f09541fc64ce88ee22d8f8f4648004fe")
		.containsOnly(
		...
		.atCommit("5989711f7315abe4c3da0f1516a3eb3a81da6716")
		.containsOnly(
		...
		test.project("https://github.com/jersey/jersey.git","master")
		.atCommit("d57b1401f874f96a53f1ec1c0f8a6089ae66a4ce")
		.containsOnly(
		...
		test.project("https://github.com/deeplearning4j/deeplearning4j.git","master")
		.atCommit("c50064efb325b0c94cc62788b4c8935b7c39ac40")
		.containsOnly(
		...
		.atCommit("2d98ae165ea43e9a1ac6a905d6094f077abb2e55")
		.containsOnly(
		...
		.atCommit("c142b8ca3e9f9467931987ee16805cf53e6bc5d2")
		.containsOnly(
		...
		.atCommit("9f422ed0f44516bea8116ed7730203e4eb316252")
		.containsOnly(
		...
		test.project("https://github.com/liferay/liferay-plugins.git","master")
		.atCommit("d99695841fa675ea9150602b1132f037093e867d")
		.containsOnly(
		...
		test.project("https://github.com/plutext/docx4j.git","master")
		.atCommit("59b8e89e61432d1d8f25cb003b62b3ac004d1b6f")
		.containsOnly(
		...
		test.project("https://github.com/datastax/java-driver.git","master")
		.atCommit("14abb6919a99a0d6d500198dd2e30c83b1bb6709")
		.containsOnly(
		...
		.atCommit("d4b4aecbc69bbd04ba87c4e32a52cff3d129906a")
		.containsOnly(
		...
		test.project("https://github.com/siacs/Conversations.git","master")
		.atCommit("e6cb12dfe414497b4317820497985c110cb81864")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("1b70adbfd49e00194c4c1170ef65e8114d7a2e46")
		.containsOnly(
		...
		test.project("https://github.com/spotify/helios.git","master")
		.atCommit("3ffd70929c08be5cf14f156189e8050969caa87e")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("b70f7ea0ce27b5defa0a7773d448732364e7aee0")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("c53c6f45988db869d56abe3b1d831ff775f4fa73")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("2b0a8f6bdac621badabcb9921c077260f2470c26")
		.containsOnly(
		...
		.atCommit("4c6ab3d77cc67c7a91155d884077520dcf1509c6")
		.containsOnly(
		...
		test.project("https://github.com/gradle/gradle.git","master")
		.atCommit("681dc6346ce3cf5be5c5985faad120a18949cee0")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("a1525ac9a0bb8f727167a8be94c81a3415128ef4")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("db024f5ec3e9611ddf8103bdc4c3817c704f7b27")
		.containsOnly(
		...
		.atCommit("0df7cb00757fe0d4fac8d8b0d5fc46af95feb238")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("7dd55014f9840ce03867bb175cf37a4c151dc806")
		.containsOnly(
		...
		.atCommit("31fc19200207ccadc45328037d8a2a62b617c029")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("92e98858e742bbb669ccbf790a71a618c581df21")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("573a1d115b86abbe3fb53ff930464d7d8fd95600")
		.containsOnly(
		...
		test.project("https://github.com/checkstyle/checkstyle.git","master")
		.atCommit("2f7481ee4e20ae785298c31ec2f979752dd7eb03")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("021d17c8234904dcb1d54596662352395927fe7b")
		.containsOnly(
		...
		.atCommit("2d8d4164830631d3125575f055b417c5addaa22f")
		.containsOnly(
		...
		test.project("https://github.com/wildfly/wildfly.git","master")
		.atCommit("d7675fb0b19d3d22978e79954f441eeefd74a3b2")
		.containsOnly(
		...
		test.project("https://github.com/openhab/openhab.git","master")
		.atCommit("f25fa3ae35e4a60a2b7f79a88f14d46ce6cebf55")
		.containsOnly(
		...
		.atCommit("e4a309c160285708f917ea23238573da3b677f7f")
		.containsOnly(
		...
		.atCommit("227254cf769f3e821ed1b2ef2d88c4ec6b20adea")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("4ccc0c37aabbd90ecaa36fcc491e2270e7e9bea6")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("c1359c843bd03a694f846c8140e24ed646bbb913")
		.containsOnly(
		...
		test.project("https://github.com/google/closure-compiler.git","master")
		.atCommit("545a7d027b4c55c116dc52d9cd8121fbb09777f0")
		.containsOnly(
		...
		test.project("https://github.com/hazelcast/hazelcast.git","master")
		.atCommit("e84e96ff5c2bdc48cea7f75fd794506159c4e1f7")
		.containsOnly(
		...
		.atCommit("309c03055b06525c275b278542c881019424760e")
		.containsOnly(
		...
		test.project("https://github.com/osmandapp/Osmand.git","master")
		.atCommit("e95aa8ab32a0334b9c941799060fd601297d05e4")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("ecd0ad5ab99b8d14f28881cf4f49ec01f2221776")
		.containsOnly(
		...
		.atCommit("8ad226067434cd39ce493b336bd0659778625959")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("3bdcaa336a6e6a9727c333b433bb9f5d3afc0fb1")
		.containsOnly(
		...
		test.project("https://github.com/netty/netty.git","master")
		.atCommit("9d347ffb91f34933edb7b1124f6b70c3fc52e220")
		.containsOnly(
		...
		.atCommit("7ffe37983e2f09637b0c84d526a2f824de652de4")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/MPS.git","master")
		.atCommit("ce4b0e22659c16ae83d421f9621fd3e922750764")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("deb8e5ca64fcf633edbd89523af472da813b6772")
		.containsOnly(
		...
		.atCommit("e19c6874431dc2c3046436c2ac249a0ab2ef3457")
		.containsOnly(
		...
		test.project("https://github.com/jOOQ/jOOQ.git","master")
		.atCommit("58a4e74d28073e7c6f15d1f225ac1c2fd9aa4357")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("6c93f15f502f39dff99ecb01b56dcad7dddb0f0d")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("0fa45e4a562fc2586b1ef06a88e9c186a0835316")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-plugins.git","master")
		.atCommit("83b3092c1ee11b70489732f9e69b8e01c2a966f0")
		.containsOnly(
		...
		test.project("https://github.com/gwtproject/gwt.git","master")
		.atCommit("892d1760c8e4c76c369cd5ec1eaed215d3a22c8a")
		.containsOnly(
		...
		test.project("https://github.com/VoltDB/voltdb.git","master")
		.atCommit("d47e58f9bbce9a816378e8a7930c1de67a864c29")
		.containsOnly(
		...
		.atCommit("fd000ca2e78fce2f8aa11e6a81e4f23c2f1348e6")
		.containsOnly(
		...
		.atCommit("f36b736cf1206dd1af794d6fb4cee967a3553b1f")
		.containsOnly(
		...
		test.project("https://github.com/dropwizard/metrics.git","master")
		.atCommit("2331fe19ea88a22de32f15375de8118226eaa1e6")
		.containsOnly(
		...
		.atCommit("eb500cca282e39d01a9882e1d0a83186da6d1a26")
		.containsOnly(
		...
		test.project("https://github.com/apache/cassandra.git","master")
		.atCommit("e37d577b6cfc2d3e11252cef87ab9ebba72e1d52")
		.containsOnly(
		...
		test.project("https://github.com/apache/pig.git","master")
		.atCommit("92dce401344a28ff966ad4cf3dd969a676852315")
		.containsOnly(
		...
		.atCommit("8bdc57ba8975d851fe91edc908761aacea624766")
		.containsOnly(
		...
		.atCommit("664923815b5aeeba2025bfe1dc5a0cd1a02a80e2")
		.containsOnly(
		...
		.atCommit("0e65ac4da70c6ca5c67bb8418e67db914218042f")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("98ecc4cfd927f388645f6a6bc492c80868b1a11d")
		.containsOnly(
		...
		test.project("https://github.com/neo4j/neo4j.git","master")
		.atCommit("e0072aac53b3b88de787e7ca653c7e17f9499018")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/intellij-community.git","master")
		.atCommit("61215911ef28ca783c5106d7c01e74cf3000a866")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("153611deab149accd8aeaf03fd102c0b069bd322")
		.containsOnly(
		...
		test.project("https://github.com/JetBrains/MPS.git","master")
		.atCommit("61b5decd4a4e5e6bbdea99eb76f136ca10915b73")
		.containsOnly(
		...
		.atCommit("e3b84c8753a21b1b15cfc9aa90b5e0c56d290f41")
		.containsOnly(
		...
		test.project("https://github.com/apache/hive.git","master")
		.atCommit("8398fbf3dd0937a0a4a3d540977a95f97425f566")
		.containsOnly(
		...
		test.project("https://github.com/spotify/helios.git","master")
		.atCommit("cc02c00b8a92ef34d1a8bcdf44a45fb01a8dea6c")
		.containsOnly(
		...
		test.project("https://github.com/CyanogenMod/android_frameworks_base.git","master")
		.atCommit("f1b8ae1c44e6ba46118c2f66eae1725259acdccc")
		.containsOnly(
		"Extract Method public of(cells Cell[][], row int, column int, size byte) : Cell extracted from public of(row int, column int, size byte) : Cell in class com.android.internal.widget.LockPatternView.Cell",
		"Extract Method public stringToPattern(string String, size byte) : List<LockPatternView.Cell> extracted from public stringToPattern(string String) : List<LockPatternView.Cell> in class com.android.internal.widget.LockPatternUtils");

		test.project("https://github.com/spring-projects/spring-framework.git","master")
		.atCommit("fffdd1e9e9dc887c3e8973147904d47d9fffbb47")
		.containsOnly(
		...
		test.project("https://github.com/liferay/liferay-plugins.git","master")
		.atCommit("720b0d2064ecc4403809e794075e9fe8cfa857f1")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("8d14e557e01cc607dd2db66c29d106ef01aa81f7")
		.containsOnly(
		...
		test.project("https://github.com/facebook/buck.git","master")
		.atCommit("89973a5e4f188040c5fcf87fb5a3e9167329d175")
		.containsOnly(
