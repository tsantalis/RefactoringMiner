...
public class TestSpecificRefactoringTest {
    ...
    void testAssumptionIntroducingRefactoring(String url,String currentCommit,String filepath,int line) throws Exception {
        Assumptions.assumeTrue(Set.of("32044d9522b881ae1b4723667695c9c01ea342aa", "e4254e385dea9b915ad74d0c8a0375848e9279f0", "ed67eeac4f9e0e8710e174db2df6da7985790240").contains(currentCommit));
