...
public abstract class AbstractMenuBar implements Renderable {
    ...
    public AbstractMenuBar(String toolName, String routePath, int id, int numOfDiffs, DiffMetaInfo metaInfo, List<String> deletedFilePaths, List<String> addedFilePaths) {
