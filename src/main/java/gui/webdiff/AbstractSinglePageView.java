...
public abstract class AbstractSinglePageView extends DirectoryDiffView implements Renderable {
    ...
    public AbstractSinglePageView(DirComparator comparator, boolean external) {
        super(comparator, external);
    }
    ...
    protected abstract void makeEachDiff(HtmlCanvas html, int i) throws IOException;
