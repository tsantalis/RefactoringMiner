...
public class CommitGraph {
    public static org.jgrapht.Graph<Node, Edge> get(String url) {
        ...
        GraphProcessor processor = new GraphProcessor(projectASTDiff.getModelDiff(), dstContentsMap, projectASTDiff.getChildContextMap());
        ...
        for (ASTDiff astDiff : projectASTDiff.getDiffSet()) {
            ...
            for (Tree subject : additions) {
                ...
                if (isUnique) {
                    processor.addHunkNode(astDiff.getDstPath(), subject);
                }
            }
        }
